...
type Midjourney struct {
	...
	ChuamgweiUserUuid string `json:"-" gorm:"type:varchar(64);column:chuamgwei_user_uuid;index"`
	CreditBizOrderNo  string `json:"-" gorm:"type:varchar(64);column:credit_biz_order_no;index"`
